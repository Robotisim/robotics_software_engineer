...
public:
    ...
    NodeStatus tick() override {
        ...
        RCLCPP_DEBUG(node_->get_logger(), "Moving to current goal: [%f, %f]", goal_x, goal_y);
...
public:
    ...
    static PortsList providedPorts() {
        return { OutputPort<double>("goal_x"), OutputPort<double>("goal_y") };
    }
};
...
int main(int argc, char** argv) {
    ...
    std::string bt_xml_file = package_share_directory + "/trees/r2_bt_go_to_goal_tree.xml";
